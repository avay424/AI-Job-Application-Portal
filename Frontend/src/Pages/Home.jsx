...
const Home = () => {
  return (
    <div className="min-h-screen bg-gray-50 w-full overflow-x-hidden">
      ...
      <section className="flex flex-col items-center justify-center text-center px-4 sm:px-6 py-16 sm:py-20 bg-[#1877F2] hover:bg-[#166FE5] text-white transition-all duration-500">

        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 transition-all duration-300 hover:scale-105">
          Welcome to JobAI Pro
        </h1>

        <p className="text-base sm:text-lg md:text-xl max-w-2xl opacity-90 transition-all duration-300 hover:opacity-100">
          Your AI-powered job application platform that helps you apply smarter, faster, and better.
        </p>
        ...
        <div className="mt-6 flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
          <Link
            to="/login"
            className="px-6 py-3 border border-white font-semibold rounded-lg hover:bg-white hover:text-blue-600 shadow-md transition-all duration-300 transform hover:scale-105 active:scale-95 w-full sm:w-auto text-center"
          >
            Get Started
          </Link>
          ...
          <Link
            to="/features"
            className="px-6 py-3 border border-white rounded-lg font-semibold hover:bg-white hover:text-blue-600 transition-all duration-300 transform hover:scale-105 active:scale-95 w-full sm:w-auto text-center"
          >
            Learn More
          </Link>
        </div>
      ...
      <section className="py-12 sm:py-16 px-4 sm:px-6">
        ...
        <h2 className="text-2xl sm:text-3xl font-bold text-center mb-10 transition-all duration-300 hover:text-[#1877F2]">
          Why Choose JobAI Pro?
        </h2>
