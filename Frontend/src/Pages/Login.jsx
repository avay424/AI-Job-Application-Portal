    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-950 px-4 text-white">
      ...
      <div className="w-full max-w-md bg-gray-900 border border-gray-800 rounded-2xl shadow-2xl p-6 sm:p-8">
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <h1 className="text-2xl font-bold mt-4">JobAI</h1>
        ...
        <div className="bg-gray-800/60 border border-gray-700 rounded-xl p-5 space-y-4">
          ...
          <div>
            ...
            <input
              className={`mt-1 w-full px-4 py-2 rounded-lg bg-gray-900 border ${errors.Email ? "border-red-500" : "border-gray-700"
          ...
          <div className="relative">
            ...
            <input
              className={`mt-1 w-full px-4 py-2 pr-16 rounded-lg bg-gray-900 border ${errors.password ? "border-red-500" : "border-gray-700"
                } focus:outline-none focus:ring-2 focus:ring-blue-500`}
          ...
          <div>
            ...
            <input
              className={`mt-1 w-full px-4 py-2 rounded-lg bg-gray-900 border ${errors.Otp ? "border-red-500" : "border-gray-700"
                } focus:outline-none focus:ring-2 focus:ring-blue-500`}
