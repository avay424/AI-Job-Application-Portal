    ...
    <div className="min-h-screen bg-gray-50 w-full overflow-x-hidden">
      ...
      <section className="py-12 sm:py-16 px-4 sm:px-6">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition-all duration-300 transform hover:scale-105 hover:shadow-blue-500/20 cursor-pointer text-center">
            <div className="text-4xl mb-3 transition-all duration-300 hover:scale-110 inline-block">📝</div>
            <h3 className="text-xl font-semibold mb-2 transition-colors duration-300 hover:text-[#1877F2]">Create Profile</h3>
            <p className="text-gray-600">
              Sign up and build your professional profile with skills, education, and experience.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition-all duration-300 transform hover:scale-105 hover:shadow-blue-500/20 cursor-pointer text-center">
            <div className="text-4xl mb-3 transition-all duration-300 hover:scale-110 inline-block">🤖</div>
            <h3 className="text-xl font-semibold mb-2 transition-colors duration-300 hover:text-[#1877F2]">AI Matches Jobs</h3>
            <p className="text-gray-600">
              Our AI analyzes your profile and suggests the best job opportunities for you.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow hover:shadow-lg transition-all duration-300 transform hover:scale-105 hover:shadow-blue-500/20 cursor-pointer text-center">
            <div className="text-4xl mb-3 transition-all duration-300 hover:scale-110 inline-block">🚀</div>
            <h3 className="text-xl font-semibold mb-2 transition-colors duration-300 hover:text-[#1877F2]">Apply Instantly</h3>
            <p className="text-gray-600">
              Apply to multiple jobs with one click and track your application status easily.
            </p>
          </div>
